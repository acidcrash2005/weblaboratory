...
@section('content')
    <div class="page-content container-fluid">
        ...
        foreach ($dataType->readRows as $row){
            if($row->field == 'user_id'){
                $user_id = $dataTypeContent->user_id;
            }else if($row->field == 'lesson_id'){
                $lesson_id = $dataTypeContent->lesson_id;
            }
        }

        $HomeworkDialog = App\HomeworkDialog::
            join('homeworks', 'homework_dialogs.id', '=', 'homeworks.dialog_id');
